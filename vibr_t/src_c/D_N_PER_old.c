...
void D_N_PER( void )//рассеянная мощность Scattered power
{
	...
	double Rh,R1,x,y,alf,bet,gam2,Ro,eta,P[3],P0[3],Pg[3],Pg0[3],alf2,bet2,//new!!!!!!!!
			u,v,ue,ve,uh,vh,***f,***fi,***fh,***fhi,del[3],Um1[3],Um2[3],T_ex,u3,v3,
			***E_r_p,***H_r_p,***E_i_p,***H_i_p,P_p[3],Pg_p[3],sz[3],cz[3],
			E_r0[3][3],H_r0[3][3],E_i0[3][3],H_i0[3][3],G2i[111],G2[111],
			...
			//	fprintf( out,"\n      2  %1d  %1d ",p,q);   
				...
				for ( g=1; g <= 2; g++ )
				{
					...
					*/
					...
					if ( !p && !q )
					{
						mult_(E_r0[g][1],E_i0[g][1], H_r0[g][2],-H_i0[g][2], &u,&v);// внешняя мощность external power

						Pg0[g] = u / P0[0];

						mult_(E_r0[g][2],E_i0[g][2], H_r0[g][1],-H_i0[g][1], &u,&v);// внешняя мощность external power
