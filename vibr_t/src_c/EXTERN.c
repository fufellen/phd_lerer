...
{ // calc. El.Magn field accounting for refl.&propagation through 5 solid layers
	double u,v,u1,v1,u2,v2,x,y,t[111],it[111],fi[111],ifi[111],C[111],iC[111],u_,v_,
		...
		rE2,iE2,rE3,iE3,Z1,s[111],si[111],EPS_ii[111];
	int N_d,n,i,j,Nsl_;
...
// _______________________________________________________
	...
	t[1] = -kap1_i[1];
	it[1] = kap1_r[1];
	t[Nsl_+1] = -kap1_i[Nsl_+1];
	it[Nsl_+1] = kap1_r[Nsl_+1];

	q[1] = iq[1] = q[Nsl_+1] = iq[Nsl_+1] = 0.0;
	...
	divide_(2.0 * t[1],2.0 * it[1],u - u1,v - v1,  &T,&iT);
	...
	for ( N_d = 2; N_d <= N_hol + 1; N_d++ )
	{
		...
		if (Pol)//p-поляризация polarization
		{
			...
			mult_(rX[2],iX[2], kap1_r[Nsl_+1],kap1_i[Nsl_+1],  &rE2,&iE2);
		...
		//s-поляризация polarization
		{
			...
			mult_(rX[2] * z,iX[2] * z, kap1_r[Nsl_+1],kap1_i[Nsl+1],  &rE2,&iE2);
