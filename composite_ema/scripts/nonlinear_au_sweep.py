...
- Guillet 2009 (PRB 79, 045410, теория/TTM): |chi_he| = 2.9e-7 esu,
  фаза 84 град, 2 ps, hbar*w = 2.39 эВ (519 нм) - строка табл. I работы;
  1.5 эВ - энергия накачки в расчётах зависимости от длительности импульса,
  к этому значению chi не относится. PDF сверен.
...
BENCHMARKS = [
    ...
    ChiBenchmark(
        ...
        518.8, 5.0e8,
        "теория TTM, 2 ps, hbar*w=2.39 эВ (табл. I работы); верхняя пс-оценка hot-electron ветки",
    ),
    ChiBenchmark(
        "DeLeon2014_fs_795nm",
